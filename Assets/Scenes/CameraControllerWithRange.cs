...
public class CameraControllerWithRange : MonoBehaviour
{
    ...
    //[SerializedField] attribute used to show private variable in the inspector-- controls how fast we want to rotate   
    ...
    private void Start()
    {
        ...
        Cursor.lockState = CursorLockMode.Locked; //locks mouse to the center of thescreen
    }
    private void Update()
    {
